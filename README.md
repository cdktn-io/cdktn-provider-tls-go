# CDKTN Go bindings for hashicorp/tls provider version 4.4.0

This repo builds and publishes the [Terraform tls provider](https://registry.terraform.io/providers/hashicorp/tls/4.4.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
* [Terraform tls provider](https://registry.terraform.io/providers/hashicorp/tls/4.4.0)
