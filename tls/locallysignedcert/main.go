...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "caPrivateKeyPemWo", GoGetter: "CaPrivateKeyPemWo"},
			_jsii_.MemberProperty{JsiiProperty: "caPrivateKeyPemWoInput", GoGetter: "CaPrivateKeyPemWoInput"},
			_jsii_.MemberProperty{JsiiProperty: "caPrivateKeyPemWoVersion", GoGetter: "CaPrivateKeyPemWoVersion"},
			_jsii_.MemberProperty{JsiiProperty: "caPrivateKeyPemWoVersionInput", GoGetter: "CaPrivateKeyPemWoVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCaPrivateKeyPem", GoMethod: "ResetCaPrivateKeyPem"},
			_jsii_.MemberMethod{JsiiMethod: "resetCaPrivateKeyPemWo", GoMethod: "ResetCaPrivateKeyPemWo"},
			_jsii_.MemberMethod{JsiiMethod: "resetCaPrivateKeyPemWoVersion", GoMethod: "ResetCaPrivateKeyPemWoVersion"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-tls.locallySignedCert.LocallySignedCertConfig",
