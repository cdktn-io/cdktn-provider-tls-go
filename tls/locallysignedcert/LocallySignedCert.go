...
import (
	...
	"github.com/cdktn-io/cdktn-provider-tls-go/tls/v14/locallysignedcert/internal"
...
func (l *jsiiProxy_LocallySignedCert) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LocallySignedCert) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LocallySignedCert) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
