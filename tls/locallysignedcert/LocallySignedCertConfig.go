...
type LocallySignedCertConfig struct {
	...
	CaPrivateKeyPem *string `field:"optional" json:"caPrivateKeyPem" yaml:"caPrivateKeyPem"`
	...
	CaPrivateKeyPemWo *string `field:"optional" json:"caPrivateKeyPemWo" yaml:"caPrivateKeyPemWo"`
	...
	CaPrivateKeyPemWoVersion *float64 `field:"optional" json:"caPrivateKeyPemWoVersion" yaml:"caPrivateKeyPemWoVersion"`
