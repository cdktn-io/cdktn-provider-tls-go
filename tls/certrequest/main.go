...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "privateKeyPemWo", GoGetter: "PrivateKeyPemWo"},
			_jsii_.MemberProperty{JsiiProperty: "privateKeyPemWoInput", GoGetter: "PrivateKeyPemWoInput"},
			_jsii_.MemberProperty{JsiiProperty: "privateKeyPemWoVersion", GoGetter: "PrivateKeyPemWoVersion"},
			_jsii_.MemberProperty{JsiiProperty: "privateKeyPemWoVersionInput", GoGetter: "PrivateKeyPemWoVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPrivateKeyPemWo", GoMethod: "ResetPrivateKeyPemWo"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrivateKeyPemWoVersion", GoMethod: "ResetPrivateKeyPemWoVersion"},
