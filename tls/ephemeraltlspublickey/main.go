...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EphemeralTlsPublicKey)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKeyConfig",
		reflect.TypeOf((*EphemeralTlsPublicKeyConfig)(nil)).Elem(),
	)
}
