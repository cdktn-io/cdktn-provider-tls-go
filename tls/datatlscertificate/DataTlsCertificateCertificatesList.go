...
func (j *jsiiProxy_DataTlsCertificateCertificatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataTlsCertificateCertificatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataTlsCertificateCertificatesList {
	_init_.Initialize()
...
func NewDataTlsCertificateCertificatesList_Override(d DataTlsCertificateCertificatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataTlsCertificateCertificatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataTlsCertificateCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataTlsCertificateCertificatesList) Resolve(context cdktn.IResolveContext) interface{} {
