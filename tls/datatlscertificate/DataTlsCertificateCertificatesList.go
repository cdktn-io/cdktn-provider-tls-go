...
func (d *jsiiProxy_DataTlsCertificateCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataTlsCertificateCertificatesList) Resolve(context cdktf.IResolveContext) interface{} {
