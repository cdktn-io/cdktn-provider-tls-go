...
type DataTlsCertificateConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.0/docs/data-sources/certificate#content DataTlsCertificate#content}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.0/docs/data-sources/certificate#url DataTlsCertificate#url}
	Url *string `field:"optional" json:"url" yaml:"url"`
	// Whether to verify the certificate chain while parsing it or not (default: `true`).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.0/docs/data-sources/certificate#verify_chain DataTlsCertificate#verify_chain}
